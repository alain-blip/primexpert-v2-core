...
| Finançabilité | `FinancabiliteTab` | `computeFinancabilite()` ; PR #47 : libellés client **RNE normalisé** / sources vérifiées |
...
*Dernière mise à jour : 2026-06-01 — PR #9 : QA règles Copilote-RPA, modules `analytics`/`forms`/`security`, triggers WORM/flywheel et index marché documentés sans doublon ; PR #47 : purge lexicale Finançabilité, aucun fichier applicatif inclus dans cette PR documentaire.*
