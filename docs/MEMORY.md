...
## PR #14 — Corrections QA règles financières et lexique (2026-06-01)

**Déclencheur :** PR [#14](https://github.com/alain-blip/primexpert-v2-core/pull/14) — branche `cursor/contr-le-qualit-r-gles-ccac` (`d13dadc` → `11535d6`).
...
**Règle de non-duplication appliquée :** le helper de capitalisation devient le point unique pour normaliser les pourcentages (`8.5` ou `0.085`) et éviter les calculs dispersés dans les moteurs ACM, les comparables, les rapports vendeur et le scénario bancaire.
...
*Journal mis à jour : 2026-06-01 — PR #14 documentée (QA finance, capitalisation SSOT, dépenses normalisées, lexique vérifié) dans la continuité PR #3.*
