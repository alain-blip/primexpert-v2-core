...
**Statut :** **[EN REVUE HITL — branché PR #10]** *(numéro de version distinct du jalon assembleur V3.5 scellé ci-dessous)*
...
**Statut :** **[EN REVUE HITL — branché PR #10]**
...
## Session 2026-06-01 — QA RNE / TGA centralisés et couverture RPA (PR #10)

**Statut :** **[DOCUMENTÉ — validation humaine Alain requise avant publication]**

| Chantier | Livrables clés |
|----------|----------------|
| **Capitalisation financière** | `packages/core/src/financial/capitalization.ts` centralise `resolveNetOperatingIncome`, `computeCapitalizationRateDecimal/Pct` et `capitalizeNoiAtCapRatePct`; `financialDataService.ts` consomme ces fonctions au lieu de recalculer localement. |
...
**Règle #0 :** les calculs RNE / TGA restent dans `@primexpert/core/financial`; l'UI et les services ne font que transmettre les résultats canoniques.

**HITL :** cette synchronisation documente le diff de la PR #10; aucune publication ni merge sans validation humaine d'Alain.

---

*Journal mis à jour : 2026-06-01 — QA RNE / TGA centralisés, couverture RPA et alignement Firestore PR #10.*
