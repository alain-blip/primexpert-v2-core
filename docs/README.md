...
| Qualité linguistique UI Finance | **EN REVUE PR #47** — Finançabilité : « revenu net d'exploitation (RNE) normalisé » remplace tout libellé client de type audit |
...
7. **Langage Québec** — Pas de « audit » à l’écran ; Finançabilité parle de **RNE normalisé** / sources vérifiées ; abréviations toujours développées (voir [MEMORY.md](./MEMORY.md)).
...
*Index mis à jour : 2026-06-01 — alignements PR #9 et PR #47 ajoutés sans dupliquer l'historique PR #3 ; PR #47 ne modifie aucun schéma Firestore.*
