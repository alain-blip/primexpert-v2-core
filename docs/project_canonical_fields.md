...
*Dernière mise à jour : 2026-06-01 — PR #9 : champs cache parse marché, WORM lié aux documents résidence, Centris/off-market, flywheel/OER et 7 délais PA acceptée alignés sans doublon ; PR #47 : aucun nouveau champ Firestore (purge lexicale UI seulement).*
