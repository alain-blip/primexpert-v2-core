...
**Sécurité WORM** : `packages/core/src/security/` — `LegalVaultDocument`, `LegalComplianceAccessLogEntry`, rétention 2190 jours.
...
| Data Flywheel | `internalMarketFlywheel.ts`, `onTransactionConcludedTrigger.ts`, `flywheelIngestion.ts` |
