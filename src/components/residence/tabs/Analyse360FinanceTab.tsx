  ...
  return (
    <div className={cn('space-y-5', inst.page)}>
      ...
      <p className={inst.note}>
        {t(
          'Comparaison du revenu brut effectif (RBE) et des dépenses normalisées (grille comptable professionnel agréé (CPA)) aux références marché. L’impact valeur est produit par le moteur financier centralisé.',
          'Compare effective gross income (EGI) and normalized expenses (CPA grid) to market references. Value impact is produced by the centralized financial engine.'
        )}{' '}
