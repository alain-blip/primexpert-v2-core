  ...
  return (
    <div className={cn('space-y-5', inst.page)}>
      ...
      <p className={inst.note}>
        {t(
          'Comparaison du revenu brut effectif (RBE) et des dépenses normalisées (grille comptable professionnel agréé (CPA)) aux références marché. L’impact valeur est fourni par le moteur financier central avec le taux de capitalisation retenu.',
          'Compare effective gross income (EGI) and normalized expenses (CPA grid) to market references. Value impact is provided by the central financial engine with the retained capitalization rate.'
        )}{' '}
