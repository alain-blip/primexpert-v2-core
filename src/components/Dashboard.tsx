  ...
  return (
    <div className="space-y-8">
        ...
        {stats.map((stat, i) => {
          ...
          return (
            <motion.div
              ...
              className="bg-[#0F172A] p-7 rounded-[32px] border border-white/[0.06] shadow-[0_24px_70px_rgba(0,0,0,0.45)] relative group hover:-translate-y-1 hover:shadow-[0_30px_90px_rgba(37,99,235,0.25)] hover:border-blue-500/30 transition-all duration-300 overflow-hidden"
            >
      ...
      <div className="grid grid-cols-1 2xl:grid-cols-3 gap-8">
        ...
        <div className="2xl:col-span-2 flex flex-col bg-[#0F172A] rounded-[36px] border border-white/[0.06] shadow-[0_28px_90px_rgba(0,0,0,0.5)] overflow-hidden group">
          <div className="p-8 border-b border-white/[0.06] flex justify-between items-start bg-[radial-gradient(circle_at_100%_0%,rgba(37,99,235,0.18),transparent_34%)]">
            <div>
              <h2 className="text-5xl font-black italic tracking-tighter uppercase leading-none text-white">{t('Tableau de bord', 'WORK_HUB')}<span className="text-blue-400 opacity-50">.V2</span></h2>
        ...
        <div className="space-y-8">
          ...
          {/* Signature rapide */}
          <div className="bg-[#0F172A] p-8 rounded-[32px] border border-white/[0.06] shadow-[0_22px_65px_rgba(0,0,0,0.4)] relative overflow-hidden group">
