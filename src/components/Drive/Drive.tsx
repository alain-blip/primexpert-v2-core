      ...
      <div className="flex items-start justify-between gap-6">
        ...
        <div>
          ...
          <button
            ...
            disabled={uploading || !brokerId}
            className="flex items-center gap-3 rounded-2xl bg-[#002f8f] px-6 py-4 text-[11px] font-black uppercase tracking-[0.2em] text-white shadow-[0_18px_38px_rgba(0,47,143,0.25)] hover:bg-blue-900 disabled:opacity-50 disabled:cursor-not-allowed transition"
          >
