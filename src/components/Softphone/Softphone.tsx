...
export function Softphone() {
  ...
  return (
    <div className="max-w-4xl mx-auto space-y-8">
      ...
      <div className="rounded-2xl border border-white/10 bg-white/70 px-5 py-4 flex items-center gap-3">
      ...
      <div className="rounded-[32px] border border-white bg-white/95 p-10 shadow-[0_24px_70px_rgba(15,23,42,0.08)] relative">
        ...
        <div className="mt-8 grid grid-cols-3 gap-3 max-w-md mx-auto">
          {KEYPAD.flat().map((digit) => (
            <button
              ...
              disabled={state === 'recording' || state === 'uploading' || state === 'requesting'}
              className="aspect-square rounded-2xl bg-white/[0.03] hover:bg-blue-500/10 active:bg-blue-100 border border-white/10 hover:border-blue-300 text-2xl font-black italic tracking-tight text-slate-100 transition disabled:opacity-40 disabled:cursor-not-allowed"
            >
              {digit}
            </button>
          ))}
        ...
        <div className="mt-6 flex items-center justify-center gap-3">
          <button
            ...
            className="flex items-center gap-2 rounded-2xl border border-white/10 bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] px-5 py-3 text-[10px] font-black uppercase tracking-widest text-slate-600 hover:border-slate-400 disabled:opacity-30 transition"
          >
          ...
          <button
            ...
            onClick={clear}
            disabled={!number || state === 'recording' || state === 'uploading'}
            className="rounded-2xl border border-white/10 bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] px-5 py-3 text-[10px] font-black uppercase tracking-widest text-slate-600 hover:border-slate-400 disabled:opacity-30 transition"
          >
          ...
          {state === 'idle' || state === 'saved' || state === 'error' ? (
            <>
              ...
              <a
                ...
                className={`flex items-center justify-center gap-3 rounded-2xl border-2 border-white/10 bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] px-6 py-5 text-slate-700 text-[11px] font-black uppercase tracking-[0.2em] hover:border-blue-300 hover:text-blue-300 transition ${!number ? 'opacity-40 cursor-not-allowed' : ''}`}
              >
            ...
            <div className="col-span-2 flex items-center justify-center gap-3 rounded-2xl bg-blue-500/10 px-6 py-5 text-blue-300 text-[11px] font-black uppercase tracking-[0.2em] border border-blue-200">
            ...
            <>
              ...
              <button
                ...
                className="flex items-center justify-center gap-3 rounded-2xl border-2 border-white/10 bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] px-6 py-5 text-slate-600 text-[11px] font-black uppercase tracking-[0.2em] hover:border-red-300 hover:text-red-700 transition"
              >
      ...
      {/* Note technique */}
      <div className="rounded-[20px] border border-white/10 bg-slate-50/50 p-5 text-[11px] leading-relaxed text-slate-600">
