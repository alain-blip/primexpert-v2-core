  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 min-h-[600px]">
      ...
      <div className="space-y-8">
        <div className="bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] p-10 rounded-[32px] border border-gray-200 shadow-sm space-y-8">
      ...
      <div className="relative">
        <div className="h-full bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] rounded-[40px] border border-gray-200 shadow-2xl overflow-hidden flex flex-col">
          ...
          {lintResult && !lintResult.isValid && (
            <div className="px-10 py-4 bg-red-50 border-b border-red-200 flex items-start gap-3">
              ...
              <button
                ...
                className="shrink-0 rounded-xl border border-red-300 bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] px-3 py-1.5 text-[10px] font-black uppercase tracking-widest text-red-700 hover:bg-red-50 transition"
              >
