  ...
  return (
    <div className="space-y-8">
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        <div className="flex items-center gap-4 bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] px-5 py-2.5 rounded-xl border border-gray-200 shadow-sm w-full md:w-96 group focus-within:border-blue-400 transition-colors">
        ...
        <div className="flex items-center gap-3">
          <button className="flex items-center gap-2 px-6 py-3 bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] text-gray-900 text-[10px] font-black uppercase tracking-widest rounded-xl hover:bg-gray-50 transition-all border border-gray-200 shadow-sm">
              ...
              <div className="space-y-4">
                {listings.filter(l => l.status === key).map((l) => (
                  <motion.div
                    ...
                    className={cn(
                      "bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] p-5 rounded-xl border-l-4 shadow-sm hover:shadow-xl transition-all cursor-pointer group",
