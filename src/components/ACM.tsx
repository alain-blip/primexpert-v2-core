...
export function ACM() {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-8">
      ...
      <div className="bg-blue-950 text-white p-10 rounded-[40px] shadow-2xl relative overflow-hidden border border-blue-900">
        ...
        <div className="relative z-10 flex flex-col gap-8">
          ...
          <button
            ...
            className="w-full py-4 bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] text-blue-300 font-black rounded-2xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 shadow-xl uppercase text-[11px] tracking-widest"
          >
      ...
      {/* Error */}
      {error && (
        <div className="flex items-center gap-3 rounded-2xl border border-red-200 bg-red-50/70 px-5 py-3 text-[11px] font-semibold text-red-800">
      ...
      {result && (
        <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] p-10 rounded-[32px] border border-gray-200 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {ratios?.map((r) => (
              <div key={r.label} className="rounded-2xl border border-gray-200 bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] p-5">
          ...
          <motion.div
            ...
            className="rounded-[28px] border border-white bg-gradient-to-br from-[#0F172A] via-[#172554] to-[#0F172A] p-8 shadow-[0_20px_60px_rgba(15,23,42,0.06)]"
          >
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-3 pt-3 border-t border-white/10">
                  {narrative.talkTrackBullets.map((b, i) => (
                    <div key={i} className="rounded-xl bg-white/[0.03] px-4 py-3">
                      ...
                      <p className="text-[11px] font-semibold text-slate-700 leading-snug">{b}</p>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="rounded-[24px] border border-white/10 bg-slate-50/70 p-6">
