      ...
      <div className="bg-blue-950 text-white p-10 rounded-[40px] shadow-2xl relative overflow-hidden border border-blue-900">
        ...
        <div className="relative z-10 flex flex-col gap-8">
          ...
          <button
            ...
            className="w-full py-4 bg-[#0F172A]/65 backdrop-blur-md text-blue-300 font-black rounded-2xl hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 shadow-xl uppercase text-[11px] tracking-widest"
          >
      ...
      {result && (
        <motion.div initial={{ opacity: 0, scale: 0.97 }} animate={{ opacity: 1, scale: 1 }} className="space-y-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div className="md:col-span-2 bg-[#0F172A]/65 backdrop-blur-md p-10 rounded-[32px] border border-gray-200 shadow-sm">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {ratios?.map((r) => (
              <div key={r.label} className="rounded-2xl border border-gray-200 bg-[#0F172A]/65 backdrop-blur-md p-5">
          ...
          <motion.div
            ...
            className="rounded-[28px] border border-white bg-[#0F172A]/65 backdrop-blur-md p-8 shadow-[0_20px_60px_rgba(15,23,42,0.06)]"
          >
