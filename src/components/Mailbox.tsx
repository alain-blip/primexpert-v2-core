...
export function Mailbox() {
  ...
  return (
    <div className="h-[calc(100vh-160px)] flex bg-[#0F172A]/55 backdrop-blur-xl rounded-[32px] border border-gray-200 shadow-sm overflow-hidden">
      {/* Sidebar List */}
      <div className={cn(
        ...
        <div className="p-6 border-b border-gray-100 bg-gray-50/50">
          ...
          <div className="relative">
            ...
            <input 
              ...
              className="w-full bg-[#0F172A]/55 backdrop-blur-xl border border-gray-200 rounded-xl py-2 pl-10 pr-4 text-[10px] font-black uppercase tracking-widest focus:ring-blue-500 focus:border-blue-500 transition-all placeholder:text-gray-300" 
            />
          </div>
        </div>
      ...
      {/* Detail View */}
      <div className={cn(
        "flex-1 flex flex-col bg-[#0F172A]/55 backdrop-blur-xl",
        !selectedId && "hidden lg:flex"
      )}>
              ...
              <div className="px-8 py-6 border-b border-gray-100 flex justify-between items-center bg-gray-50/30">
                <div className="flex items-center gap-4">
                  ...
                  <div className="flex gap-2">
                    <button className="p-2 hover:bg-[#0F172A]/55 backdrop-blur-xl hover:shadow-sm rounded-lg transition-all text-gray-400 hover:text-blue-400 border border-transparent hover:border-gray-100">
                      <Archive className="w-4 h-4" />
                    </button>
                    <button className="p-2 hover:bg-[#0F172A]/55 backdrop-blur-xl hover:shadow-sm rounded-lg transition-all text-gray-400 hover:text-red-500 border border-transparent hover:border-gray-100">
                ...
                <div className="max-w-3xl">
                  ...
                  <div className="mt-12 pt-8 border-t border-gray-100">
                    <div className="flex items-center gap-4 p-4 bg-gray-50 rounded-xl border border-gray-100 border-dashed group cursor-pointer hover:border-blue-300 transition-colors">
                      <div className="p-3 bg-[#0F172A]/55 backdrop-blur-xl rounded-lg shadow-sm">
